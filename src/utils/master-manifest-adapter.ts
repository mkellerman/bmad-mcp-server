 ...
 */
export function masterRecordToWorkflow(record: MasterRecord): Workflow {
  return {
    // Primary identification
    name: record.name || '',
 ...
 */
export function masterRecordToTask(record: MasterRecord): Task {
  return {
    // Primary identification
    name: record.name || '',
    description: record.description || '',
 ...
 */
export function convertWorkflows(records: MasterRecord[]): Workflow[] {
  const existingRecords = filterExisting(records);
 ...
 */
export function convertTasks(records: MasterRecord[]): Task[] {
  const existingRecords = filterExisting(records);
