...
<activation critical="MANDATORY">
  ...
  <step n="4">Consult {project-root}/bmad/bmm/debug/debug-index.csv to select knowledge fragments under `knowledge/` and load only the files needed for the current task</step>
  <step n="5">Load the referenced fragment(s) from `{project-root}/bmad/bmm/debug/knowledge/` before giving recommendations</step>
