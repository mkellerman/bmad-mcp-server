...
The project has transitioned to the first stable 1.0.0 release via
semantic-release. No runtime API changes were required; this marks the project
as stable and ready for broader adoption. Future breaking changes will bump the
major version in the 1.x series.
