...
export function originsFromResolution(discovery) {
...
export function buildMasterManifests(origins) {
    const master = {
        agents: [],
        workflows: [],
        tasks: [],
...
function detectVersion(root) {
    ...
    if (detectV4(root))
        return 'v4';
    if (detectV6Filesystem(root))
        return 'v6';
    return 'unknown';
}
//# sourceMappingURL=master-manifest.js.map